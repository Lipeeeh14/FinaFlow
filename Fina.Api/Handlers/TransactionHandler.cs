...
public class TransactionHandler(AppDbContext context) : ITransactionHandler
{
	public async Task<Response<Transaction?>> CreateAsync(CreateTransactionRequest request)
	{
		...
		{
			return new Response<Transaction?>(null, 400, "Erro ao criar a transação!");
		}
	}
	...
	public async Task<Response<Transaction?>> DeleteAsync(DeleteTransactionRequest request)
	{
		...
		{
			return new Response<Transaction?>(null, 400, "Erro ao excluir a transação!");
		}
	}
	...
	public async Task<Response<Transaction?>> GetByIdAsync(GetTransactionByIdRequest request)
	{
		...
		{
			return new Response<Transaction?>(null, 400, "Não foi possível obter a transação!");
		}
	}
	...
	public async Task<PagedResponse<IEnumerable<Transaction>?>> GetByPeriodAsync(GetTransactionsByPeriodRequest request)
	{
		...
		{
			return new PagedResponse<IEnumerable<Transaction>?>(null, 400, "Não foi possível obter as transações!");
		}
	}
	...
	public async Task<Response<Transaction?>> UpdateAsync(UpdateTransactionRequest request)
	{
		...
		{
			return new Response<Transaction?>(null, 400, "Erro ao atualizar a transação!");
		}
	}
}
